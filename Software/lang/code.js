...
// Populate the language selection menu.
  ...
  $('#a_maquette').text(MSG['span_maquette']);
...
//NBR: Load FRENCH by default... This allow to have a definition for additionnal blocks messages in case another langage is chosen
